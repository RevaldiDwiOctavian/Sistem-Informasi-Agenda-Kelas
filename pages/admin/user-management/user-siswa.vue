<template>
  <div>
    <v-row>
      <v-col cols="12" sm="12">
        <v-card class="pa-4 text-h5" tile> Kelola User Siswa </v-card>
      </v-col>
    </v-row>
    <v-row>
      <v-col>
...
Admin mendapati bahwa ada agenda kelas yang belum di konfirmasi. Mohon untuk segera mengonfirmasi agenda kelas.
`
